...
`pathspec` -- replaces both the old shell grep/awk chains and an earlier
`fnmatch`-based ignore tuple, neither of which understood negation
patterns or directory-anchored rules correctly.
